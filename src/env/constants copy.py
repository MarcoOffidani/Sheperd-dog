...
NUM_PEDESTRIANS = 5                        # ! number of pedestrians
EPS = 1e-8 
ENSLAVING_DEGREE = 0.2                       # ! leader's enslaving degree

# Area params
WIDTH = 10.0                                 # ! geometry of environment space: width
HEIGHT = 10.0                                # ! geometry of environment space: height
STEP_SIZE = 0.1                            # ! 0.1, 0.05, 0.01
NOISE_COEF = 0.01                            # ! randomization in viscek model
...
SWITCH_DISTANCE_TO_LEADER = 3             # radius of catch by leader
SWITCH_DISTANCE_TO_OTHER_PEDESTRIAN = 1   # SWITCH_DISTANCE_TO_LEADER
SWITCH_DISTANCE_TO_EXIT   = 6.1
SWITCH_DISTANCE_TO_ESCAPE = 0.1
SWITCH_DISTANCE_TO_FALL = 0.01
